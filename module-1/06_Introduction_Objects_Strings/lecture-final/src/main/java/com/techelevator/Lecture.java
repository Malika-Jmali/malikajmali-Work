...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		Account myCheckingAccount; //declared a variable of type Account
		myCheckingAccount = new Account();   //instantiated (created it in memory
        myCheckingAccount.setBalance(100.00);
