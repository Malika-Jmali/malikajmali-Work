...
public class Exercises {
	...
	public static void main(String[] args) {
        ...
        */
		...
		int raccoonsLeftInTheWoods = raccoonsPlayingInTheWoods - raccoonsEatDinner;
        ...
        */
		...
		int numberOfBess = 3;
		int numberOfExtraFlowers= numberOfFlowers - numberOfBess ;
        ...
        */
		...
		int anotherPigeonEatBreadcrumbs = 1;
		int totalPigeonsEatingBreadcrumbs = lonelyPigeonEatingBreadcrumbs + anotherPigeonEatBreadcrumbs;
        ...
        */
		...
		int owlsJoined = 2;
		int totalOwlsOnTheFence= owlsSittingOnTheFence +owlsJoined;
        ...
        */
		...
		int beaversStillWorkingOnHome = beaversWorkingOnTheirHome - beaversWentForSwim;
        ...
        many toucans in all?
        */
		int toucansSittingTreeLimb = 2;
		int toucanJoins = 1;
		int toucansAll = toucansSittingTreeLimb + toucanJoins;
        ...
        */
		...
		int nutsInTree = 2;
		int numbersExtraSquirrels = squirrelsInTree - nutsInTree;
        ...
        */
		...
		int firstGradeAllMuffins = briesMuffins+macAdamMuffins+flanneryMuffins;
		System.out.println(briesMuffins + macAdamMuffins + flanneryMuffins);
...
// String dollarSign = "$"; //Why whouldn't this work???
        ...
        */
		int hiltHouse = 29;
		int brecknock = 17;
		int moreSnowHilt = hiltHouse -brecknock ;
        ...
        */
		...
		double toyTruck = 3;
		double pencilCase = 2;
		double moneyLeftHilt = hiltMoney - toyTruck - pencilCase;
        ...
        */
		...
		int meganWants = 25;
		int meganSeashellsNeed= meganWants - meganSeashells ;
        ...
        */
		...
		System.out.println("Two cones cost " + costOfCones + ".");
        ...
        */
		int rocksNeeded = 125;
		int rocksNow = 64;
		int moreRocksNedeed = rocksNeeded - rocksNow;
        ...
        */
		int milesDrove = 78;
		int  theyDrove = 32;
		int milesLeft =  milesDrove - theyDrove ;
        ...
        */
		...
		double cupcakeEachPerson = cupcakes / children;
		System.out.println(cupcakeEachPerson);
        ...
        */
		...
		double guests = 7;
		double croissantsEach =croissants / guests ;
	    ...
	    */
		...
		System.out.println(hoursToPaint5Rooms);
	    /* Exercise 52
