...
public class App {
    ...
    public static void main(String[] args) {
        ...
        ConsoleService consoleService = new ConsoleService();   //user interface or menu just different name
        HotelService hotelService = new HotelService(API_BASE_URL);   // also could have been called webservice dao
        ...
        while (menuSelection != 0) {
            ...
            if (menuSelection == 1) {
                ...
                // int hotel id = consoleService.askUserForId()  - better way than hard-coding
                ...
                System.out.println(hotelService.getWithCustomQuery().getFull_name());
